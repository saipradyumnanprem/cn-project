...
btn1 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Abyssinica SIL', 26),command=clicked1)
btn1.grid(column=1, row=1, sticky = S+N+E+W)
btn2 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Abyssinica SIL', 26), command=clicked2)
btn2.grid(column=2, row=1, sticky = S+N+E+W)
btn3 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Abyssinica SIL', 26),command=clicked3)
btn3.grid(column=3, row=1, sticky = S+N+E+W)
btn4 = Button(leftFrame, text=" ",bg="black", fg="#ffff00",width=8,height=3,font=('Abyssinica SIL', 26),command=clicked4)
btn4.grid(column=1, row=2, sticky = S+N+E+W)
btn5 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Abyssinica SIL', 26),command=clicked5)
btn5.grid(column=2, row=2, sticky = S+N+E+W)
btn6 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Abyssinica SIL', 26),command=clicked6)
btn6.grid(column=3, row=2, sticky = S+N+E+W)
btn7 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Abyssinica SIL', 26),command=clicked7)
btn7.grid(column=1, row=3, sticky = S+N+E+W)
btn8 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Abyssinica SIL', 26),command=clicked8)
btn8.grid(column=2, row=3, sticky = S+N+E+W)
btn9 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Abyssinica SIL', 26),command=clicked9)
btn9.grid(column=3, row=3, sticky = S+N+E+W)


btnQuit=Button (rightFrame3, text="Quit", font=('Abyssinica SIL', 15, 'bold'), height = 1, width =15,command = clickQuit) 
...
lbl.grid (row=0, column=0, sticky=W)
lblUsername=Label(rightFrame1, font=('Abyssinica SIL', 15, 'bold'), text="Player1",padx=2, pady=2, bg="#1919A6",width=10) 
lblUsername.grid (row=0, column=1, sticky=W)
lbl=Label(rightFrame1, font=('Abyssinica SIL', 15, 'bold'), text="Turn: ",padx=2, pady=2, fg="#ffff00", bg="#1919A6") 
lbl.grid (row=1, column=0, sticky=W)
lblTurn=Label(rightFrame1, font=('Abyssinica SIL', 15, 'bold'), text="Opponent",padx=2, pady=2, bg="#1919A6",width=10) 
