...
leftFrame = Frame (mainFrame ,bd=10, width =750, height=500, pady=2, padx=10, bg="#1919A6", relief=RIDGE)
leftFrame.pack(side=LEFT)

rightFrame = Frame (mainFrame,bd=10, width =560, height=500, padx=10, pady=2, bg="#1919A6", relief=RIDGE)
rightFrame.pack(side=RIGHT)

rightFrame1=Frame(rightFrame ,bd=10, width=560, height=200, padx=10, pady=2, bg="#1919A6", relief=RIDGE) 
rightFrame1.grid(row=0, column=0)

rightFrame2 = Frame(rightFrame,bd=10, width =560, height=250, padx=10, pady=2, bg="#1919A6", relief=RIDGE)
rightFrame2.grid(row=1,column=0)

rightFrame3=Frame(rightFrame ,bd=10, width=560, height=150, padx=10, pady=2, bg="#1919A6", relief=RIDGE) 
...
btn1 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Arcade Interlaced', 26),command=clicked1)
btn1.grid(column=1, row=1, sticky = S+N+E+W)
btn2 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Arcade Interlaced', 26), command=clicked2)
btn2.grid(column=2, row=1, sticky = S+N+E+W)
btn3 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Arcade Interlaced', 26),command=clicked3)
btn3.grid(column=3, row=1, sticky = S+N+E+W)
btn4 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Arcade Interlaced', 26),command=clicked4)
btn4.grid(column=1, row=2, sticky = S+N+E+W)
btn5 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Arcade Interlaced', 26),command=clicked5)
btn5.grid(column=2, row=2, sticky = S+N+E+W)
btn6 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Arcade Interlaced', 26),command=clicked6)
btn6.grid(column=3, row=2, sticky = S+N+E+W)
btn7 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Arcade Interlaced', 26),command=clicked7)
btn7.grid(column=1, row=3, sticky = S+N+E+W)
btn8 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Arcade Interlaced', 26),command=clicked8)
btn8.grid(column=2, row=3, sticky = S+N+E+W)
btn9 = Button(leftFrame, text=" ",bg="Black", fg="#ffff00",width=8,height=3,font=('Arcade Interlaced', 26),command=clicked9)
btn9.grid(column=3, row=3, sticky = S+N+E+W)

btnConnect=Button(rightFrame3, text="Connect", font=('Abyssinica SIL', 15, 'bold'), height = 1, width =20,command=clickConnect)
btnConnect.grid (row=2, column=0 ,padx=6, pady=11)

btnQuit=Button (rightFrame3, text="Quit", font=('Abyssinica SIL', 15, 'bold'), height = 1, width =20, command = clickQuit) 
btnQuit.grid(row=3, column=0 ,padx=6, pady=10)

lbl=Label(rightFrame2, font=('Abyssinica SIL', 15, 'bold'), text="Games:",padx=2, pady=2,fg="#ffff00", bg="#1919A6") 
lbl.grid (row=0, column=0, sticky=W)
lblGames=Label(rightFrame2, font=('Abyssinica SIL', 15, 'bold'), text=" ",padx=2, pady=2, bg="#1919A6",width=8) 
lblGames.grid (row=0, column=1, sticky=W)
lbl=Label(rightFrame2, font=('Abyssinica SIL', 15, 'bold'), text="Won:",padx=2, pady=2,fg="#ffff00", bg="#1919A6") 
lbl.grid (row=1, column=0, sticky=W)
lblWon=Label(rightFrame2, font=('Abyssinica SIL', 15, 'bold'), text=" ",padx=2, pady=2, bg="#1919A6",width=8) 
lblWon.grid (row=1, column=1, sticky=W)
lbl=Label(rightFrame2, font=('Abyssinica SIL', 15, 'bold'), text="Lost:",padx=2, pady=2,fg="#ffff00", bg="#1919A6") 
lbl.grid (row=2, column=0, sticky=W)
lblLost=Label(rightFrame2, font=('Abyssinica SIL', 15, 'bold'), text=" ",padx=2, pady=2, bg="#1919A6",width=8) 
lblLost.grid (row=2, column=1, sticky=W)
lbl=Label(rightFrame2, font=('Abyssinica SIL', 15, 'bold'), text="Ties:",padx=2, pady=2,fg="#ffff00", bg="#1919A6") 
...
lbl=Label(rightFrame1, font=('Abyssinica SIL', 15, 'bold'), text="Player2:",padx=2, pady=2, bg="#1919A6") 
lbl.grid (row=0, column=0, sticky=W)
lblUsername=Label(rightFrame1, font=('Abyssinica SIL', 15, 'bold'), text="",padx=2, pady=2, bg="#1919A6",width=8) 
lblUsername.grid (row=0, column=1, sticky=W)
lbl=Label(rightFrame1, font=('Abyssinica SIL', 15, 'bold'), text="Turn: ",padx=2, pady=2, bg="#1919A6") 
lbl.grid (row=1, column=0, sticky=W)
lblTurn=Label(rightFrame1, font=('Abyssinica SIL', 15, 'bold'), text="You",padx=2, pady=2, bg="#1919A6",width=8) 
